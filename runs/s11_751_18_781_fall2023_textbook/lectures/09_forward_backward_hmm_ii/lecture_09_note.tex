...
\newcommand{\videopublishdate}{2023-09-27}
\newcommand{\videoduration}{unknown}
\newcommand{\videourl}{https://www.youtube.com/watch?v=ct\_ZEdYi12Q}
...
从证据位置看，这一部分对应的课程证据区间是 2023-09-27。课程在这里强调的核心内容可以概括为：Forward-Backward Algorithm for HMM | Forward-backward algorithm for HMM。
...
\section{总结与延伸}
Forward-Backward Algorithm for HMM 这一讲在整门《Speech Recognition and Understanding》课程中的位置，是把 Forward-Backward for HMM II 讲成一个可复用的建模模块。
